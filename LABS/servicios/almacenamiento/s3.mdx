...
import IconS3 from '../diagrams/icon-s3.svg';

# 🗄️ Amazon S3 — Simple Storage Service

<IconS3 title="Amazon S3" width="72" height="72" />
...
![Estructura de Amazon S3](../diagrams/s3-estructura.svg)
...
![Modelo de seguridad S3](../diagrams/s3-seguridad.svg)
