...
import IconBedrock from '../diagrams/icon-bedrock.svg';

# Amazon Bedrock

<IconBedrock title="Amazon Bedrock" width="72" height="72" />
...
![Arquitectura RAG con Bedrock](../diagrams/bedrock-rag.svg)
