...
import IconCloudWatch from './diagrams/icon-cloudwatch.svg';
...
![Arquitectura del laboratorio — Servidor Web EC2](diagrams/arquitectura.svg)
...
![Una VPC aísla la instancia EC2; solo entra el tráfico que el Security Group permite](diagrams/concepto-vpc.svg)
:::
...
![Sin una regla de entrada el tráfico se bloquea; con la regla HTTP se permite](diagrams/concepto-sg.svg)
:::
...
<IconCloudWatch title="Amazon CloudWatch" width="64" height="64" />
...
![Escalado vertical: de t3.micro/8 GiB a t3.small/10 GiB](diagrams/escalado-vertical.svg)
...
![Ciclo de vida de una instancia EC2: Pendiente → En ejecución → Detenida → Terminada](diagrams/ciclo-vida-ec2.svg)
